...
\hypersetup{
  ...
  pdfauthor={Version 1.5.0, 2025-06-12},
  colorlinks=true,
  linkcolor={blue},
  filecolor={Maroon},
  citecolor={Blue},
...
\ifdefined\Shaded\renewenvironment{Shaded}{\begin{tcolorbox}[borderline west={3pt}{0pt}{shadecolor}, boxrule=0pt, interior hidden, sharp corners, breakable, frame hidden, enhanced]}{\end{tcolorbox}}\fi
...
\bottomrule\noalign{}
\endlastfoot
1.5.0 & 2025-06-12 & \begin{minipage}[t]{\linewidth}\raggedright
\begin{itemize}
\tightlist
\item
