...
<!-- changing the orientation to landscape, thank you https://stackoverflow.com/questions/74229798/create-a-multiple-page-orientation-in-a-single-quarto-pdf-output --------------------------------- -->

\newpage

\KOMAoptions{paper=landscape,pagesize}
\recalctypearea
\newgeometry{vmargin=2cm,left=2cm,right=2cm}
