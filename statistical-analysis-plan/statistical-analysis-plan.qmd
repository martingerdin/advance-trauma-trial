...
csl: nature.csl
# Cache chunk output so prose edits do not rebuild shell tables/figures.
# Refresh with: quarto render statistical-analysis-plan.qmd --cache-refresh
execute:
  cache: true
---
...
We will report the actual roll-out of the trial in the supplementary material, showing for each cluster the planned patient-inclusion window together with the observed standard-care, transition, and intervention periods, and marking each ATLS^®^ training course on top of that cluster's bar (@fig-trial-rollout).
...
We will describe cluster characteristics including state and size using frequencies and percentages for discrete variables and medians and interquartile ranges (Q1-Q3) for continuous variables. State categories depend on the final set of participating clusters. We will present these characteristics in the main text. See @tbl-cluster-characteristics for a shell with simulated data.
...
<!-- sap-revision-todo J7: non-floating longtable so placement stays in document order. -->
We will describe patient characteristics among all eligible patients over the entire trial period, stratified by before and after ATLS training and overall, using frequencies and percentages for discrete variables and medians and interquartile ranges (Q1-Q3) for continuous variables. Missing values will be reported for each characteristic. We will not adjust for clustering when presenting baseline characteristics (i.e. non-outcome variables). We will present key characteristics in the main text, see @tbl-patient-characteristics, and present all characteristics in the supplementary material, see @tbl-patient-characteristics-all. Both shells use simulated data.
...
- **Missing data.** The outcome is not observed and no value is constructed for it. Such observations are excluded from the analysis of that outcome under the available-case approach, or imputed under the multiple imputation approach, as specified under @sec-missing-data.
...
The captions in this section state whether each table or figure is intended for the main text or the supplementary material of the trial report. Values in the shells are simulated so the layout can be reviewed before data collection is complete; they are not trial results.
...
#| fig.cap: "Shell figure of the actual trial roll-out. Light gray bars show the planned patient-inclusion window. Coloured bars show the observed standard-care, transition, and intervention periods. Each ATLS® training course is marked with a diamond on top of that cluster's bar; a cluster may have more than one course. Placeholder dates will be replaced with observed dates. Intended for the supplementary material."
#| fig.align: "center"
#| fig-pos: H
#| out-width: "100%"
#| message: FALSE
...
#| fig.cap: "Cluster-level CONSORT diagram shell with simulated counts. Boxes cover clusters assessed and randomised, losses and exclusions after randomisation with reasons, and clusters included in the primary analysis, by sequence and overall. The flowchart summarises data across all batches 1-6. Intended for the main text."
#| fig.align: "center"
#| fig-pos: H
#| out-width: "100%"
#| message: FALSE
...
#| fig.cap: "Patient-level CONSORT diagram shell with simulated counts. Boxes cover patients entered, losses and exclusions from the primary analysis with reasons, and patients analysed, by sequence, before and after ATLS training, and overall. The flowchart summarises data across all batches 1-6. Intended for the main text."
#| fig.align: "center"
#| fig-pos: H
#| out-width: "100%"
#| message: FALSE
...
#| tbl-cap: "Cluster characteristics (simulated data). Intended for the main text."
#| echo: false
#| message: false
#| warning: false
#| results: asis
...
#| tbl-cap: "Key patient characteristics (simulated data). Intended for the main text."
#| echo: false
#| message: false
#| warning: false
#| results: asis
...
#| tbl-cap: "All patient characteristics (simulated data). Intended for the supplementary material."
#| echo: false
#| message: false
#| warning: false
#| results: asis
...
#| tbl-cap: "Intercurrent events by outcome (simulated data). Intended for the supplementary material."
#| echo: false
#| message: false
#| warning: false
#| results: asis
...
#| tbl-cap: "Descriptive summaries of key outcomes (simulated data). Intended for the main text."
#| echo: false
#| message: false
#| warning: false
#| results: asis
...
#| tbl-cap: "Descriptive summaries of all outcomes (simulated data). Intended for the supplementary material."
#| echo: false
#| message: false
#| warning: false
#| results: asis
...
#| tbl-cap: "Shell table of key primary and secondary outcome analysis results (simulated data). Intended for the main text."
#| echo: false
#| message: false
#| warning: false
#| results: asis
...
#| tbl-cap: "Shell table of all primary and secondary outcome analysis results (simulated data). Intended for the supplementary material."
#| echo: false
#| message: false
#| warning: false
#| results: asis
...
#| tbl-cap: "Shell table of sensitivity, fully adjusted, and subgroup analysis results for the primary outcome (simulated data). Intended for the supplementary material."
#| echo: false
#| message: false
#| warning: false
#| results: asis
...
#| tbl-cap: "Shell table of within-cluster correlation parameters for all outcomes (simulated data). Intended for the supplementary material."
#| echo: false
#| message: false
#| warning: false
#| results: asis
...
#| fig.cap: "Forest plot of subgroup-specific intervention effects on in-hospital mortality within 30 days (simulated data). Intended for the main text."
#| fig.align: "center"
#| fig-pos: H
#| echo: false
#| message: false
...
#| tbl-cap: "Safety events (simulated data). Intended for the main text."
#| echo: false
#| message: false
#| warning: false
#| results: asis
