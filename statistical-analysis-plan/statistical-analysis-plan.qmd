...
<!-- github-issue-22: draft from protocol withdrawal/follow-up; CONSORT flow moved here from Analysis sets. -->
Patient participants may withdraw consent for collection of non-routinely recorded data at any time before the final analysis. Further trial-specific follow-up and collection of such data will then stop. Participants may also request that already collected data be removed from the trial before final analysis. Withdrawal of consent or removal of data does not affect clinical care; any subsequent follow-up is according to the participating hospital’s routine. Clusters that leave the trial after randomisation will be documented with reasons where available.

Enrolled patients will be followed daily until discharge for injury information. Mortality outcomes will be assessed at 24 hours, 30 days, and three months after arrival at the emergency department, and functional outcomes and return to work at 30 days and three months; patients discharged before a scheduled time point will be followed by phone. Loss to follow-up and withdrawal will be summarised overall and by intervention condition.

<!-- sap-revision-todo H3 (comment id=9 MGW; Round Two): stepped-wedge CONSORT extension for flow diagram. -->
We will use a CONSORT diagram to display the flow of hospitals, clusters, and patients through the trial, see @fig-consort-diagram. The diagram will report, for each sequence (and overall), the numbers of clusters and patients randomly assigned, receiving the intended intervention condition according to the scheduled transition, excluded after randomisation (with reasons), and included in the primary analysis. We will present cluster-level summaries of the intervention effect. We will report the study according to the CONSORT guidelines for stepped-wedge randomised trials [@Hemming2018].
...
<!-- Should include:
- The population of clusters and individuals for whom the treatment effect is to be estimated for (e.g., all live births, all women having a C-section)
-->
