...
Unless otherwise stated, secondary outcomes will be analysed using the same mixed-effects modelling framework as specified for the primary outcome, including fixed effects for time and intervention exposure and random effects for cluster and cluster-by-period, with the link function and outcome distribution adapted to the scale of the outcome. Model diagnostics will be used to assess distributional assumptions, the proportional-odds assumption for cumulative logit models, and model convergence.
