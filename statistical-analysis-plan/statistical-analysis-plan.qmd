...
Length of emergency department stay will be analysed as a continuous outcome using the linear mixed-effects model specified in @eq-linear-model.

### Length of hospital stay

Length of hospital stay will be analysed as a continuous outcome using the linear mixed-effects model specified in @eq-linear-model.
...
Length of intensive care unit stay will be analysed as a continuous outcome using the linear mixed-effects model specified in @eq-linear-model.
...
Where $\mathbb{E}(Y_{bkti})$ denotes the expected adherence proportion. The intervention effect $\theta$ represents the difference in mean adherence on the logit scale.
