...
<!-- sap-revision-todo I2 (comments id=80, id=81, id=82): SAP-only secondary-outcome / power framing; shared include left unchanged. -->
...
<!-- sap-revision-todo J4: content of the interim report to the joint SDMC. -->
The Trial Team will prepare the interim analysis report for the joint Trial Steering and Data Monitoring Committee (SDMC), for approval by the Trial Management Group before circulation. The report will follow the standard SDMC report template and will include:

- numbers of clusters included and dropping out;
- numbers of potentially eligible participants screened, participants included, participants who did not consent to out-of-hospital follow-up, and participants lost to follow-up, overall and by intervention condition;
...
- numbers of physicians trained in ATLS® in each hospital;
- protocol deviations and proposed protocol amendments;
- safety events, as defined for SDMC monitoring; and
...
Sensitivity, fully adjusted, and subgroup analyses of the primary outcome will be reported in the same style. See @tbl-additional-analyses-results.
