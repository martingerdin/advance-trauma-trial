...
[^randomisation]: **Question:** Karla and James, can you please provide more details on how the randomisation will be done?
...
[^kenward-and-roger]: **Questions about Kenward and Roger small sample correction:** 1. What clusters do we consider here? Doctors? Patients? Hospitals? 2. Why use this method and not eg. bootstrapping? I thought Kenward and Roger was primarly used for linear mixed models and not for binary outcomes? 
...
Fully adjusted covariate analysis will additionally adjust for[^additional-covariates]:
