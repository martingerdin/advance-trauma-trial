...
<!-- github-issue-22: CONSORT flow moved here from Analysis sets; shell covers assigned/received/analysed and post-randomisation losses. -->

<!-- sap-revision-todo H3 (comment id=9 MGW; Round Two): stepped-wedge CONSORT extension for flow diagram. -->
We will use a CONSORT diagram to display the flow of hospitals, clusters, and patients through the trial, see @fig-consort-diagram. For each sequence and period, the diagram will report the numbers of clusters and patients randomly assigned (or included under that sequence), who received the intended intervention condition, who were lost or excluded after randomisation (with reasons), and who were analysed for the primary outcome. We will present cluster-level summaries of the intervention effect. We will report the study according to the CONSORT guidelines for stepped-wedge randomised trials [@Hemming2018].

```{r}
#| echo: false
#| label: fig-consort-diagram
#| fig.cap: "Consort diagram shell. For each sequence and period, placeholders cover clusters and patients randomly assigned or included, receipt of the intended intervention, losses and exclusions after randomisation with reasons, and analysis for the primary outcome."
#| fig.align: "center"
#| message: FALSE
#| warning: FALSE
