...
Comparative effect measures for the intervention are listed by outcome in @tbl-outcomes-summary and are estimated from the mixed-effects models in Analysis methods (cluster-specific effects unless otherwise stated):
