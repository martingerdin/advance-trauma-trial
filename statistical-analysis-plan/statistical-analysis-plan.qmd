...
<!-- github-issue-75: shell of actual roll-out (standard care, transition, intervention, training dots) driven by tables/cluster-rollout.csv. -->
We will report the actual roll-out of the trial in the supplementary material, showing for each cluster the observed standard-care, transition, and intervention periods, with ATLS^®^ training dates overlaid (@fig-trial-rollout).
...
<!-- github-issue-75: actual roll-out shell; dates from tables/cluster-rollout.csv. -->

```{r}
#| echo: false
#| label: fig-trial-rollout
#| fig.cap: "Shell figure of the actual trial roll-out. Placeholder dates will be replaced with the observed standard-care, transition, and intervention periods for each cluster, with ATLS® training dates shown as points. Intended for the supplementary material."
#| fig.align: "center"
#| fig-pos: H
#| out-width: "100%"
#| message: FALSE
