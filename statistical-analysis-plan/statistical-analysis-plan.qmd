...
We will assess adherence to ATLS® principles in both the standard care and ATLS® periods using a 14-item checklist that covers the key steps of the ATLS® primary survey. Adherence will be measured as the proportion of completed items on this checklist. This outcome will be analysed using a mixed-effects beta regression model with a logit link:
