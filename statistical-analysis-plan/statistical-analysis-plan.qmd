...
We will report the actual roll-out of the trial in the supplementary material, showing for each cluster the observed standard-care, transition, and intervention periods, with each ATLS^®^ training course marked on top of that cluster's bar (@fig-trial-rollout).
...
#| fig.cap: "Shell figure of the actual trial roll-out. Placeholder dates will be replaced with the observed standard-care, transition, and intervention periods for each cluster. Each ATLS® training course is marked with a diamond on top of that cluster's bar; a cluster may have more than one course. Intended for the supplementary material."
#| fig.align: "center"
#| fig-pos: H
#| out-width: "100%"
#| message: FALSE
