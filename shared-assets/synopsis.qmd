...
**Sample Size** 
`r number_to_text(clusters)` clusters and at least `r number_to_text(sample.size)` patients.
...
*Patients participants* are adult trauma patients who present to the emergency department of participating hospitals and are admitted or transferred for admission.
